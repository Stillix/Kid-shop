...
public class TestResultController {
  ...
  public String showTestResults(
    ...
    model.addAttribute(RequestAttributeName.TEST_RESULT_PAGE, testPage);
    return "test-results";
  }
  ...
  public String showEditForm(@PathVariable("id") Long testResultId, Model model) {
    ...
    model.addAttribute(RequestAttributeName.TEST_RESULT_DTO, testResultDto);
  ...
  public String updateTestResult(@ModelAttribute TestResultDto testResultDto, RedirectAttributes redirectAttributes) {
    ...
    redirectAttributes.addFlashAttribute(RequestAttributeName.MESSAGE, "Test result (№ = " + testResultDto.getTestResultId() + ") has been update successfully");
    return "redirect:/cv-service/test-results";
  }

  @GetMapping("/cv-service/test-result/new")
  public String showCreateForm(Model model) {
    model.addAttribute(RequestAttributeName.TEST_RESULT_DTO, new TestResultDto());
  ...
  public String saveTestResult(@ModelAttribute TestResultDto testResultDto, RedirectAttributes redirectAttributes) {
    ...
    redirectAttributes.addFlashAttribute(RequestAttributeName.MESSAGE, "Test result has been add successfully");
    return "redirect:/cv-service/test-results";
  }
}
